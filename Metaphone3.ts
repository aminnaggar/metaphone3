...
export class Metaphone3 {
   ...
   */
  MAX_KEY_ALLOCATION: number;

  /**
   * Default maximum length of encoded key.
   */
  DEFAULT_MAX_KEY_LENGTH: number;

  public constructor(incomingCharString?: any) {
    if (typeof incomingCharString === "string" || incomingCharString === null) {
      let __args = arguments;
      {
        ...
        if (this.m_metaphLength === undefined) {
          this.m_metaphLength = 0;
        }
        if (this.m_encodeVowels === undefined) {
          this.m_encodeVowels = false;
        }
        if (this.m_encodeExact === undefined) {
          this.m_encodeExact = false;
        }
        if (this.m_current === undefined) {
          this.m_current = 0;
        }
        if (this.m_last === undefined) {
          this.m_last = 0;
        }
        if (this.flag_AL_inversion === undefined) {
    ...
    } else if (incomingCharString === undefined) {
      let __args = arguments;
      if (this.m_length === undefined) {
        this.m_length = 0;
      }
  ...
  GetMaximumKeyLength(): number {
    return this.MAX_KEY_ALLOCATION | 0;
  }
